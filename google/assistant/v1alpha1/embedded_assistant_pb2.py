...
# source: google/assistant/v1alpha1/embedded_assistant.proto
...
ConverseConfig = _reflection.GeneratedProtocolMessageType('ConverseConfig', (_message.Message,), dict(
  ...
  __module__ = 'google.assistant.v1alpha1.embedded_assistant_pb2'
